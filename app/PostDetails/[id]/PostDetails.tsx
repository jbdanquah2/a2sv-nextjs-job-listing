...
import TagButton, { TagButtonVariant } from '@/components/TagButton/TagButton';
...
const PostDetails: React.FC<JobPosting> = ({
            ...
            <li key={index} className="text-red-400 ">
                <span className="check-icon ">
                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M10.5 3.33335C6.81812 3.33335 3.83335 6.31812 3.83335 10C3.83335 13.6819 6.81812 16.6667 10.5 16.6667C14.1819 16.6667 17.1667 13.6819 17.1667 10C17.1667 6.31812 14.1819 3.33335 10.5 3.33335ZM2.16669 10C2.16669 5.39765 5.89765 1.66669 10.5 1.66669C15.1024 1.66669 18.8334 5.39765 18.8334 10C18.8334 14.6024 15.1024 18.3334 10.5 18.3334C5.89765 18.3334 2.16669 14.6024 2.16669 10Z" fill="#56CDAD"/>
                        <path fillRule="evenodd" clipRule="evenodd" d="M13.5893 7.74408C13.9147 8.06951 13.9147 8.59715 13.5893 8.92259L10.2559 12.2559C9.93051 12.5814 9.40287 12.5814 9.07743 12.2559L7.41076 10.5893C7.08533 10.2638 7.08533 9.73618 7.41076 9.41074C7.7362 9.08531 8.26384 9.08531 8.58928 9.41074L9.66669 10.4882L12.4108 7.74408C12.7362 7.41864 13.2638 7.41864 13.5893 7.74408Z" fill="#56CDAD"/>
                        </g>
                        <defs>
    ...
    const formatIdealCandidate = (idealCandidate: string) => {
    ...
    <div className="post-details">
      <div className="post-details__content">
        <div className="content-card">
          ...
          <section className="ideal-candidate-section">
            <h2>Ideal Candidate we want</h2>
            <ul>
              {formatIdealCandidate(idealCandidate)}
            </ul>
          </section>
            ...
            <div className="location-info">
              <span className="location-icon">
                  <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path fillRule="evenodd" clipRule="evenodd" d="M25 20.5005C25 19.1192 23.8808 18 22.5005 18C21.1192 18 20 19.1192 20 20.5005C20 21.8808 21.1192 23 22.5005 23C23.8808 23 25 21.8808 25 20.5005Z" stroke="#26A4FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      <path fillRule="evenodd" clipRule="evenodd" d="M22.4995 31C21.301 31 15 25.8984 15 20.5633C15 16.3866 18.3571 13 22.4995 13C26.6419 13 30 16.3866 30 20.5633C30 25.8984 23.698 31 22.4995 31Z" stroke="#26A4FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
              </span>
              <p>{whenAndWhere}</p>
            </div>
        ...
        <div className="sidebar-card">
            ...
            <div className="info-item">
              <span className="icon">
                  <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="1" y="0.5" width="43" height="43" rx="21.5" fill="white"/>
                      <rect x="1" y="0.5" width="43" height="43" rx="21.5" stroke="#D6DDEB"/>
                      <path d="M31.5 22C31.5 26.9706 27.4706 31 22.5 31C17.5294 31 13.5 26.9706 13.5 22C13.5 17.0294 17.5294 13 22.5 13M22.5 13C23.9368 13 25.295 13.3367 26.5 13.9355C26.5 13.9355 25.3085 13.4068 24.5 13.223C23.7337 13.0488 22.5 13 22.5 13ZM22.5 19V25M25.5 22H19.5" stroke="#26A4FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
              </span>
              <div>
                <h3>Posted On</h3>
                <p>{reFormatDate(datePosted)}</p>
              </div>
            </div>
            ...
            <div className="info-item">
              <span className="icon">
                  <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="1" y="0.5" width="43" height="43" rx="21.5" fill="white"/>
                      <rect x="1" y="0.5" width="43" height="43" rx="21.5" stroke="#D6DDEB"/>
                      <path d="M17.25 13V15.25M27.75 13V15.25M13.5 28.75V17.5C13.5 16.2574 14.5074 15.25 15.75 15.25H29.25C30.4926 15.25 31.5 16.2574 31.5 17.5V28.75M13.5 28.75C13.5 29.9926 14.5074 31 15.75 31H29.25C30.4926 31 31.5 29.9926 31.5 28.75M13.5 28.75V21.25C13.5 20.0074 14.5074 19 15.75 19H29.25C30.4926 19 31.5 20.0074 31.5 21.25V28.75" stroke="#26A4FF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M20.5 22.8768C20.5 22.5906 20.8069 22.4092 21.0577 22.5471L24.9179 24.6703C25.1779 24.8132 25.1779 25.1868 24.9179 25.3297L21.0577 27.4529C20.8069 27.5908 20.5 27.4094 20.5 27.1232V22.8768Z" stroke="#26A4FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
              </span>
              <div>
                <h3>Start Date</h3>
                <p>{reFormatDate(startDate)}</p>
              </div>
            </div>
            ...
            <div className="info-item">
              <span className="icon">
                  <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <rect x="1" y="0.5" width="43" height="43" rx="21.5" stroke="#D6DDEB"/>
                      <path d="M17.25 13V15.25M27.75 13V15.25M13.5 28.75V17.5C13.5 16.2574 14.5074 15.25 15.75 15.25H29.25C30.4926 15.25 31.5 16.2574 31.5 17.5V28.75M13.5 28.75C13.5 29.9926 14.5074 31 15.75 31H29.25C30.4926 31 31.5 29.9926 31.5 28.75M13.5 28.75V21.25C13.5 20.0074 14.5074 19 15.75 19H29.25C30.4926 19 31.5 20.0074 31.5 21.25V28.75" stroke="#26A4FF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M20.5 24.7222L22.2778 26.5L24.9444 22.5" stroke="#26A4FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
              </span>
              <div>
                <h3>End Date</h3>
                <p>{reFormatDate(endDate)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="categories-section">
            ...
            {categories?.map((category: string, index: number) => {
                      let tagClass: TagButtonVariant = "location";
                      if (index % 2 == 0) {
                          tagClass = "category-1";
                      } else {
                          tagClass = "location";
                      ...
                      return (
                          <TagButton key={index} noBorder={true} variant={`${tagClass}`}>{category}</TagButton>
                      )
                  })}
            </div>
          </div>
