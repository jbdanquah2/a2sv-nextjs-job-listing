...
const PostDetails: React.FC<JobPosting> = ({
    ...
    whenAndWhere}) => {
        ...
        categories.push('testing3')
        categories.push('testing4')
  ...
  return (
    <div className="post-details">
      <div className="post-details__content">
        <section className="post-details__description">
          <h2>Description</h2>
          <p>{description}</p>
        </section>

        <section className="post-details__responsibilities">
          <h2>Responsibilities</h2>
          {formatResponsibilities(responsibilities)}
        </section>

        <section className="post-details__ideal-candidate">
          <h2>Ideal Candidate we want</h2>
          {formatIdealCandidate(idealCandidate)}
        </section>

        <section className="post-details__when-where">
          <h2>When & Where</h2>
          <div className="location-info">
            <span className="location-icon">
                <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M25 20.5005C25 19.1192 23.8808 18 22.5005 18C21.1192 18 20 19.1192 20 20.5005C20 21.8808 21.1192 23 22.5005 23C23.8808 23 25 21.8808 25 20.5005Z" stroke="#26A4FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M22.4995 31C21.301 31 15 25.8984 15 20.5633C15 16.3866 18.3571 13 22.4995 13C26.6419 13 30 16.3866 30 20.5633C30 25.8984 23.698 31 22.4995 31Z" stroke="#26A4FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </span>
            <p>{whenAndWhere}</p>
          </div>
          ...
          <div className="info-item">
            <span className="icon">
                <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="0.5" width="43" height="43" rx="21.5" fill="white"/>
                    <rect x="1" y="0.5" width="43" height="43" rx="21.5" stroke="#D6DDEB"/>
                    <path d="M17.25 13V15.25M27.75 13V15.25M13.5 28.75V17.5C13.5 16.2574 14.5074 15.25 15.75 15.25H29.25C30.4926 15.25 31.5 16.2574 31.5 17.5V28.75M13.5 28.75C13.5 29.9926 14.5074 31 15.75 31H29.25C30.4926 31 31.5 29.9926 31.5 28.75M13.5 28.75V21.25C13.5 20.0074 14.5074 19 15.75 19H29.25C30.4926 19 31.5 20.0074 31.5 21.25V28.75" stroke="#26A4FF" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M20.5 22.8768C20.5 22.5906 20.8069 22.4092 21.0577 22.5471L24.9179 24.6703C25.1779 24.8132 25.1779 25.1868 24.9179 25.3297L21.0577 27.4529C20.8069 27.5908 20.5 27.4094 20.5 27.1232V22.8768Z" stroke="#26A4FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </span>
            <div>
              <h3>Start Date</h3>
          ...
          <div className="info-item">
            <span className="icon">
                <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect x="1" y="0.5" width="43" height="43" rx="21.5" stroke="#D6DDEB"/>
                    <path d="M17.25 13V15.25M27.75 13V15.25M13.5 28.75V17.5C13.5 16.2574 14.5074 15.25 15.75 15.25H29.25C30.4926 15.25 31.5 16.2574 31.5 17.5V28.75M13.5 28.75C13.5 29.9926 14.5074 31 15.75 31H29.25C30.4926 31 31.5 29.9926 31.5 28.75M13.5 28.75V21.25C13.5 20.0074 14.5074 19 15.75 19H29.25C30.4926 19 31.5 20.0074 31.5 21.25V28.75" stroke="#26A4FF" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M20.5 24.7222L22.2778 26.5L24.9444 22.5" stroke="#26A4FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </span>
            <div>
              <h3>End Date</h3>
